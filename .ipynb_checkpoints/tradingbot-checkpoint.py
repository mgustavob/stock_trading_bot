 ...
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       ...
       " 'ABT Abbott Laboratories NYSE Health Care Equipment $188.84B $7.605B 59.89 26.85 1.17 5.118M 77.18% 21 Oct 2020 $103.75 -1.00%',\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    company_info.index('NYSE')\n",
    "if 'NYSEMKT' in company_info:\n",
    "    company_info.index('NYSEMKT')\n",
    "    "
   ]
  },
  {
